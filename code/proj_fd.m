...
hard_negative_path = non_face_scn_path;
...
if strcmp(classifier_method, 'svm')
...
% confidence level.
if testctrl == 1
    features_hard_neg = get_hard_negatives(hard_negative_path, feature_params, w, b);
...
% [b_bboxes, b_confidences, b_image_ids] = run_detector(bonus_test_scn_path, w, b, feature_params);
...
% 
% [b_gt_ids, b_gt_bboxes, b_gt_isclaimed, b_tp, b_fp, b_duplicate_detections] = ...
%     bonus_evaluate_detections(b_bboxes, b_confidences, b_image_ids, bonus_label_path);
